...
with open('/home/giacomo/Scrivania/evaluation/pipeline_outcome_TA2bis_linking/Yang_Python/relaxedMatchResults_coref3.json') as f:
...
with open('/home/giacomo/Scrivania/evaluation/linking/linking_outcome_coref3.json', 'w') as outfile:
